...
var ImageMapper = function (props) {
    ...
    var renderPrefilledAreas = function (mapObj) {
        ...
        mapObj.areas.map(function (area) {
            ...
            (0, draw_1.default)(area.shape, scaleCoords(area.coords), area.preFillColor, area.lineWidth || lineWidthProp, area.strokeColor || strokeColorProp, true, ctx, area.cosmeticId || undefined, area.id);
            return true;
        });
    };
